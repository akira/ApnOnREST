...
describe DevicesController do
  ...
  def mock_device(stubs={})
    @mock_device ||= mock_model(APN::Device, stubs).as_null_object
  end

  describe "GET index" do
    it "assigns all devices as @devices" do
      APN::Device.stub(:all) { [mock_device] }
      get :index
  ...
  describe "GET show" do
    it "assigns the requested device as @device" do
      APN::Device.stub(:find).with("37") { mock_device }
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new device as @device" do
      APN::Device.stub(:new) { mock_device }
      get :new
      assigns(:device).should be(mock_device)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created device as @device" do
        APN::Device.stub(:new).with({'these' => 'params'}) { mock_device(:save => true) }
        post :create, :device => {'these' => 'params'}
        assigns(:device).should be(mock_device)
      end

      it "redirects to the created device" do
        APN::Device.stub(:new) { mock_device(:save => true) }
        post :create, :device => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved device as @device" do
        APN::Device.stub(:new).with({'these' => 'params'}) { mock_device(:save => false) }
        post :create, :device => {'these' => 'params'}
        assigns(:device).should be(mock_device)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "assigns the requested device as @device" do
        APN::Device.stub(:find) { mock_device(:update_attributes => true) }
        put :update, :id => "1"
        assigns(:device).should be(mock_device)
      end
    ...
    describe "with invalid params" do
      it "assigns the device as @device" do
        APN::Device.stub(:find) { mock_device(:update_attributes => false) }
        put :update, :id => "1"
        assigns(:device).should be(mock_device)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the devices list" do
      APN::Device.stub(:find) { mock_device }
      delete :destroy, :id => "1"
